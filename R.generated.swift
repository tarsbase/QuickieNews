...
struct R: Rswift.Validatable {
  ...
  struct string {
    ...
    struct localizable {
      ...
      /// en translation: Order by category
      /// 
      /// Locales: en
      static let read_later_sort_category = Rswift.StringResource(key: "read_later_sort_category", tableName: "Localizable", bundle: R.hostingBundle, locales: ["en"], comment: nil)
      /// en translation: Order by date ⬆️
      /// 
      /// Locales: en
      static let read_later_sort_date_inc = Rswift.StringResource(key: "read_later_sort_date_inc", tableName: "Localizable", bundle: R.hostingBundle, locales: ["en"], comment: nil)
      /// en translation: Order by date ⬇️
      /// 
      /// Locales: en
      static let read_later_sort_date_dec = Rswift.StringResource(key: "read_later_sort_date_dec", tableName: "Localizable", bundle: R.hostingBundle, locales: ["en"], comment: nil)
      ...
      /// 
      /// Locales: en
      static func read_later_sort_category(_: Void = ()) -> String {
        return NSLocalizedString("read_later_sort_category", bundle: R.hostingBundle, comment: "")
      }
      
      /// en translation: Order by date ⬆️
      /// 
      /// Locales: en
      static func read_later_sort_date_inc(_: Void = ()) -> String {
        return NSLocalizedString("read_later_sort_date_inc", bundle: R.hostingBundle, comment: "")
      }
      
      /// en translation: Order by date ⬇️
      /// 
      /// Locales: en
      static func read_later_sort_date_dec(_: Void = ()) -> String {
        return NSLocalizedString("read_later_sort_date_dec", bundle: R.hostingBundle, comment: "")
      }
